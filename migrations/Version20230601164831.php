 ...
 */
final class Version20230601164831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bet DROP INDEX UNIQ_FBF0EC9B9D86650F, ADD INDEX IDX_FBF0EC9B9D86650F (user_id_id)');
        $this->addSql('ALTER TABLE bet CHANGE user_id_id user_id_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bet DROP INDEX IDX_FBF0EC9B9D86650F, ADD UNIQUE INDEX UNIQ_FBF0EC9B9D86650F (user_id_id)');
        $this->addSql('ALTER TABLE bet CHANGE user_id_id user_id_id INT DEFAULT NULL');
